...
import PinnedComposer from "@/components/liveblocks/comments/PinnedComposer";
import NewCommentCursor from "@/components/liveblocks/comments/NewCommentCursor";
...
const NewComment = ({ children }: NewThreadProps) => {
  ...
  return (
    <>
      ...
      <NewCommentCursor display={creatingCommentState === "placing"} />
    </>
  );
};
